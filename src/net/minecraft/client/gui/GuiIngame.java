...
public class GuiIngame extends Gui {
   ...
   public void func_175180_a(float p_175180_1_) {
      ...
      String xd =(Client.developerMode ? "Developer Build" : (username.equalsIgnoreCase("Neohack") ? "Special ED Build" : (username.equalsIgnoreCase("Aki") ? "Beta Cutie Build" : (username.equals("Kaxon") ? "Fake Trap Build" : (username.equals("Phase") ? "Fightbot Build" : (username.equals("Koala") ? "Dumb Fag Build" : "Release Build")))))) + " - §f§l" + Client.version + " §7- §l" + username;
