...
import exhibition.module.impl.movement.ZoomFly;
   ...
   public void onEvent(Event event) {
      if (mc.thePlayer != null && mc.thePlayer.ticksExisted > 0) {
         if (event instanceof EventPacket) {
            ...
            Module[] toggleModules = new Module[]{(Module)Client.getModuleManager().get(LongJump.class), (Module)Client.getModuleManager().get(Speed.class),(Module)Client.getModuleManager().get(ZoomFly.class)};
            ...
            if (wasDisabled) {
               Notifications.getManager().post("LagBack check!", "Disabled movement modules.", 200L, Notifications.Type.WARNING);
            }
