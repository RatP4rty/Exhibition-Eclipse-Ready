      ...
      if (!mc.gameSettings.showDebugInfo) {
                  ...
                  if (ek.getKey() == 208) {
                     ...
                     if (this.getSettings(this.selectedModule) != null) {
                        ...
                        while(var20.hasNext()) {
                           ...
                           if ((float)longestString < font.getWidth(modxd.getName() + ": \247l" + faggotXD)) {
         ...
         if (event instanceof EventRenderGui) {
            ...
            if (this.inSet) {
               ...
               font.drawStringWithShadow("\247l<", (float)this.settingBoxX + 2.0F, this.selectedSettingT.getY() + 1.5F, Colors.getColor(255, 255, 255, this.opacity + 64));
               GlStateManager.disableBlend();
               GlStateManager.popMatrix();
            }
         }
