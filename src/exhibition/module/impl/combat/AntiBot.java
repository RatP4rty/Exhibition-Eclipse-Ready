   ...
   public void onDisable() {
      ...
      try {
         if (mc.getCurrentServerData() != null && mc.getCurrentServerData().serverIP != null && mc.getCurrentServerData().serverIP.toLowerCase().contains("hypixel") || mc.getCurrentServerData().serverIP.toLowerCase().contains("mineplex")) {
            ChatUtil.printChat("\2474[\247cE\2474]\2478 AntiBot was kept enabled for your protection.");
            this.toggle();
         }
         ...
         if (em.isPre()) {
            if (mc.getIntegratedServer() == null) {
               if (mc.getCurrentServerData().serverIP.toLowerCase().contains("hypixel") && !currentSetting.equals("Hypixel")) {
                  ...
                  ChatUtil.printChat("\2474[\247cE\2474]\2478 AntiBot has been set to the proper mode.");
            ...
            while(true) {
               while(true) {
                  ...
                  case 0:
                     ...
                     if ((str.equalsIgnoreCase(ent.getName() + "\247r") || str.equalsIgnoreCase(ent.getName()) || str.contains("NPC") || !getTabPlayerList().contains(ent)) && str.equalsIgnoreCase(ent.getName() + "\247r") && !getTabPlayerList().contains(ent) && mc.getCurrentServerData() != null && mc.getCurrentServerData().serverIP.toLowerCase().contains("hypixel") && mc.getIntegratedServer() == null && ent.ticksExisted < 10 && ent.getDistance(ent.lastTickPosX, ent.lastTickPosY, ent.lastTickPosZ) > 10.0D) {
                        ;
                     }

                     if (ent.isInvisible() && ent.ticksOnGround < 5 && str.equalsIgnoreCase(ent.getName() + "\247r")) {
                        mc.theWorld.removeEntity(ent);
                     } else if (str.equalsIgnoreCase(ent.getName() + "\247r") || str.equalsIgnoreCase(ent.getName()) || str.contains("NPC")) {
                        if (str.equalsIgnoreCase(ent.getName() + "\247r") && !getTabPlayerList().contains(ent) && mc.getCurrentServerData() != null && mc.getCurrentServerData().serverIP.toLowerCase().contains("hypixel") && mc.getIntegratedServer() == null && (!ent.onGround || !ent.isCollidedVertically) && Math.abs(ent.posY - mc.thePlayer.posY) > 7.0D) {
                           mc.theWorld.removeEntity(ent);
                        } else {
                           this.timer.reset();
                           invalid.add(ent);
