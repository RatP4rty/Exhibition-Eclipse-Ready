            ...
            while(true) {
               while(true) {
                  ...
                  if (egg.rotationYaw == 0.0F && egg.ticksExisted <= 1 && (mc.thePlayer.posY - egg.posY == -1.59375D || mc.thePlayer.posY - egg.posY == -1.53125D) && mc.thePlayer.getDistanceToEntity(egg) <= 2.0F) {
                     DevNotifications.getManager().post("\2474[\247cE\2474]\2478 YChange " + Math.abs(RotationUtils.getYawChange(egg.posX, egg.posZ)) + " " + mc.thePlayer.getDistanceToEntity(egg));
                     ...
                     DevNotifications.getManager().post("\2476\247l" + this.possibleDamage + " will be expected. ");
                  }
               }
            }
         }
