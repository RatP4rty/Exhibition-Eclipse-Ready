...
import exhibition.module.impl.render.Health;
...
public class ModuleManager extends AbstractManager {
   ...
   public void setup() {
      ...
      this.add(new Spotify(new ModuleData(ModuleData.Type.Other, "Spotify", "Spotify Mod.")));
      ...
      this.add(new ZoomFly(new ModuleData(ModuleData.Type.Movement, "ZoomFly", "Boost Hypixel Fly")));
