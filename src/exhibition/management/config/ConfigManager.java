   ...
   public void createConfig(String configName) {
      ...
      if (configDir.isDirectory()) {
         ...
         for(int var5 = 0; var5 < var4; ++var5) {
            ...
            if (file.getAbsolutePath().endsWith(".cfg") && file.getAbsolutePath().contains(configName + ".cfg")) {
               ChatUtil.printChat("\2474[\247cE\2474]\2478 Config already exists!");
               return;
            }
         }
      }
      ...
      try {
         if (file.createNewFile()) {
            ...
            ChatUtil.printChat("\2474[\247cE\2474]\2478 Successfully created config file!");
         }
      } catch (IOException var7) {
         ChatUtil.printChat("\2474[\247cE\2474]\2478 An internal error occurred: \247c" + var7.getMessage());
      }
      ...
      if (configDir.isDirectory()) {
         ...
         for(int var5 = 0; var5 < var4; ++var5) {
            ...
            if (file.getAbsolutePath().endsWith(".cfg") && file.getAbsolutePath().toLowerCase().contains(configName.toLowerCase() + ".cfg")) {
               if (file.delete()) {
                  ChatUtil.printChat("\2474[\247cE\2474]\2478 Config deleted successfully!");
               } else {
                  ChatUtil.printChat("\2474[\247cE\2474]\2478 An error occurred deleting config.!");
               }
         ...
         ChatUtil.printChat("\2474[\247cE\2474]\2478 No configs with the name \"\2477" + configName + "\2478\" exist! Try \247a.config list\2478!");
      }
         ...
         while(true) {
            ...
            if (file.getAbsolutePath().endsWith(".cfg") && file.getAbsolutePath().toLowerCase().contains(configName.toLowerCase() + ".cfg")) {
               ...
               try {
                  ...
                  ChatUtil.printChat("\2474[\247cE\2474]\2478 Config loaded successfully!");
                  return;
               } catch (Exception var10) {
                  ChatUtil.printChat("\2474[\247cE\2474]\2478 Error loading config!");
               }
            }
         ...
         while(true) {
            ...
            if (file.getAbsolutePath().endsWith(".cfg") && file.getAbsolutePath().toLowerCase().contains(configName.toLowerCase() + ".cfg")) {
               ...
               try {
                  ...
                  out.close();
                  ChatUtil.printChat("\2474[\247cE\2474]\2478 Config saved successfully!");
                  return;
               } catch (Exception var11) {
                  ChatUtil.printChat("\2474[\247cE\2474]\2478 An error occurred while saving config: \247c" + var11.getMessage());
               }
            }
