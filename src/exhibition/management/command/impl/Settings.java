      ...
      if (args == null) {
         ...
         if (module == null) {
            ...
            if (args.length == 1) {
               ...
               ChatUtil.printChat("\2474[\247cE\2474]\2478 [" + EnumChatFormatting.DARK_RED + module.getName() + EnumChatFormatting.DARK_GRAY + "] - Settings: " + EnumChatFormatting.DARK_RED + moduleSettings.size());
               ...
               if (args.length == 2) {
                  ...
                  try {
                     if (setting.getValue() instanceof Number) {
                        ...
                        if (newValue != null) {
                           ChatUtil.printChat("\2474[\247cE\2474]\2478 " + module.getName() + "'s " + setting.getName().toLowerCase() + " has been changed to: " + EnumChatFormatting.DARK_AQUA + newValue);
                        ...
                        if (setting.getValue().getClass().equals(String.class)) {
                           ...
                           ChatUtil.printChat("\2474[\247cE\2474]\2478 " + module.getName() + "'s " + setting.getName().toLowerCase() + " has been changed to: " + EnumChatFormatting.DARK_RED + parsed);
                        ...
                        if (setting.getValue().getClass().equals(Boolean.class)) {
                           ChatUtil.printChat("\2474[\247cE\2474]\2478 " + module.getName() + "'s " + setting.getName().toLowerCase() + " has been changed to: " + EnumChatFormatting.DARK_RED + objText);
                  ...
                  ChatUtil.printChat("\2474[\247cE\2474]\2478 ERROR: Could not apply the value '" + objText + "' to " + module.getName() + "'s " + setting.getName());
               }
            }
