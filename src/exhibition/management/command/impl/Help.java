      ...
      if (args == null) {
         ...
         while(var4.hasNext()) {
            ...
            if (!used.contains(command.getName())) {
               ...
               ChatUtil.printChat("\2474[\247cE\2474]\2478 " + i + ". " + command.getName() + " - " + command.getDescription());
               ++i;
            }
         }

         ChatUtil.printChat("\2474[\247cE\2474]\2478 Specify a name of a command for details about it.");
      } else if (args.length > 0) {
         String name = args[0];
         Command command = Client.commandManager.getCommand(name);
         if (command == null) {
            ChatUtil.printChat("\2474[\247cE\2474]\2478 Could not find: " + name);
            return;
         }

         ChatUtil.printChat("\2474[\247cE\2474]\2478 " + command.getName() + ": " + command.getDescription());
