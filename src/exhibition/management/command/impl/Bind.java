      ...
      if (args == null) {
         ...
         if (module == null) {
            ...
            if (args.length == 1) {
               ...
               ChatUtil.printChat("\2474[\247cE\2474]\2478 " + module.getName() + ": " + (key.getMask() == KeyMask.None ? "" : key.getMask().name() + " + ") + key.getKeyStr());
            } else {
               Keybind keybind;
               int keyIndex;
               if (args.length == 2) {
                  ...
                  ChatUtil.printChat("\2474[\247cE\2474]\2478 Set " + module.getName() + " to " + (keybind.getMask() == KeyMask.None ? "" : keybind.getMask().name() + " + ") + keybind.getKeyStr());
                  ...
                  module.setKeybind(keybind);
                  Keybind key = module.getKeybind();
                  ChatUtil.printChat("\2474[\247cE\2474]\2478 Set " + module.getName() + " to " + (key.getMask() == KeyMask.None ? "" : key.getMask().name() + " + ") + key.getKeyStr());
               }
            }
