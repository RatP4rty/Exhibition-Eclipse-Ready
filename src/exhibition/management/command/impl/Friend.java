            ...
            if (!args[0].equalsIgnoreCase("add") && !args[0].equalsIgnoreCase("a")) {
               if (args[0].equalsIgnoreCase("del") || args[0].equalsIgnoreCase("d")) {
                  if (FriendManager.isFriend(args[1])) {
                     ...
                     ChatUtil.printChat("\2474[\247cE\2474]\2478 Removed friend: " + args[1]);
                  } else {
                     ChatUtil.printChat("\2474[\247cE\2474]\2478 " + args[1] + " is not your friend.");
                  }
               }
            } else {
               if (FriendManager.isFriend(args[1])) {
                  ChatUtil.printChat("\2474[\247cE\2474]\2478 " + args[1] + " is already your friend.");
               }

               FriendManager.removeFriend(args[1]);
               FriendManager.addFriend(args[1], args.length == 3 ? args[2] : args[1]);
               ChatUtil.printChat("\2474[\247cE\2474]\2478 Added " + args[1]);
            }
