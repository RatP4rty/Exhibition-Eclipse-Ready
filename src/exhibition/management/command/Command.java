...
public abstract class Command implements Fireable, MinecraftUtil {
   ...
   public static final String chatPrefix = "\2474[\247cE\2474]\2478 ";
   ...
   protected void printDescription() {
      String message = "\2474[\247cE\2474]\2478 " + this.getName() + EnumChatFormatting.GRAY + ": " + this.description;
      ChatUtil.printChat(message);
   }

   protected void printUsage() {
      String message = "\2474[\247cE\2474]\2478 " + this.getName() + EnumChatFormatting.GRAY + ": " + this.getUsage();
      ChatUtil.printChat(message);
   }
