...
public class GuiModdedMainMenu extends GuiMainMenu {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      this.mc.fontRendererObj.drawStringWithShadow("net.minecraft.client.main.Main Menu", 0.0F, 0.0F, -1);
      GlStateManager.popMatrix();
      ...
      GlStateManager.popMatrix();
      String welcome = "Welcome back, \247e" + Crypto.decryptPublicNew(Client.authUser.getEncryptedUsername());
      ...
      String currentBuld = "Your current build is: " + (Client.version.equals(Client.parsedVersion) ? "\247aLatest\247f!" : "\247cOutdated\247f!");
