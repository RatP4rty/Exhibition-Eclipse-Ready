...
public class SkeetMenu extends UI {
   ...
   public void dropDownButtonDraw(DropdownButton p0, DropdownBox p1, float x, float y) {
      ...
      font.drawStringWithShadow((!hovering && !active ? "" : "\247l") + p0.name, p0.x + 3.0F + xOff, p0.y + 2.0F + yOff, active ? Colors.getColor(ColorManager.hudColor.red, ColorManager.hudColor.green, ColorManager.hudColor.blue, (int)this.opacity.getOpacity()) : -1);
   ...
   public void multiDropDownButtonDraw(MultiDropdownButton p0, MultiDropdownBox p1, float x, float y) {
      ...
      TTFFontRenderer font = hovering ? Client.test2 : Client.test3;
      font.drawStringWithShadow((!hovering && !active ? "" : "\247l") + p0.setting.getName().charAt(0) + p0.setting.getName().toLowerCase().substring(1), p0.x + 3.0F + xOff, p0.y + 2.0F + yOff, active ? Colors.getColor(ColorManager.hudColor.red, ColorManager.hudColor.green, ColorManager.hudColor.blue, (int)this.opacity.getOpacity()) : Colors.getColor(255, (int)this.opacity.getOpacity()));
      GlStateManager.popMatrix();
   }
   ...
   public void colorPickerClick(HSVColorPicker cp, float x, float y, int mouse) {
      ...
      if (mouse == 0) {
         try {
            ...
            DevNotifications.getManager().post("\247c" + var10.getMessage() + " exception!");
         }
      }
